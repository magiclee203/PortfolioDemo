...
namespace Technie.PhysicsCreator
{
	...
	{
		[MenuItem("Window/Technie Collider Creator/Generate Colliders From Selection", false, 2000)]
		...
		[MenuItem("Window/Technie Collider Creator/Span From Selection", false, 2000)]
		...
		private static void EnsureDepth(GameObject obj)
		{
			...
			{
				//Console.output.Log("Extrude on local X");
			...
			{
				//Console.output.Log("Extrude on local Y");
			...
			{
				//Console.output.Log("Extrude on local Z");
