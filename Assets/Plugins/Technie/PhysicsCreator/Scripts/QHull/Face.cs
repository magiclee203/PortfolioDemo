...
namespace Technie.PhysicsCreator.QHull
{
	 ...
	 *
	 * The information stored for each face consists of a planar normal,
	 * a planar offset, and a doubly-linked list of three HalfEdges which
	 * surround the face in an anti-clockwise direction.
	 *
	 */
	public class Face
	{
